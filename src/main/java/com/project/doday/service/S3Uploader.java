...
public class S3Uploader {
    ...
    public List<String> uploadAll(String dirName, List<MultipartFile> files) {
    ...
    public void deleteAll(String dirName, List<String> imageNames) {
        imageNames.forEach(name -> delete(dirName, name));
    }

    public void delete(String dirName, String imageName) {
